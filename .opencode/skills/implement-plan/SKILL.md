---
name: implement-plan
description: Use ONLY when the user explicitly invokes implement-plan by name.
---
...
Use the `task` tool with `subagent_type=general` to implement the current phase. Provide clear instructions about which phase to implement.
...
`Read(.opencode/skills/implement-plan/references/implement_plan_final_answer.md)`
